                ...
                return (
                    <>
                        <FlatList
                            ...
                            data={data.products.filter(item => item.location == 'The Stein')}
                            numColumns={1}
...
//               renderItem={({ item }) => <MenuListingItem item={item} navigation={navigation} location={'The Stein'} />}
//           />}
//       </ListingsWrapper>
//   )
// };
